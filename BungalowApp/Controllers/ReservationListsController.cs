...
namespace BungalowApp.Controllers
{
    public class ReservationListsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ReservationList.Include(r => r.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,ReservationDate,Description")] ReservationList reservationList)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<AppUser>(), "Id", "Email", reservationList.UserId);
            return View(reservationList);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ReservationDate,Description")] ReservationList reservationList)
        {
        ...
        {
          return (_context.ReservationList?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
