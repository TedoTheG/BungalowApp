...
namespace BungalowApp.Controllers
{
    public class BungalowsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BungalowId,Slots,Smokers,Pets,Location,PricePerNight,ReservationListId")] Bungalow bungalow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BungalowId,Slots,Smokers,Pets,Location,PricePerNight,ReservationListId")] Bungalow bungalow)
        {
            if (id != bungalow.Id)
            {
                return NotFound();
